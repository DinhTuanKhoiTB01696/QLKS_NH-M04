...
namespace DAL_QLKS
{
    ...
    {
        public virtual NhanVien getNhanVien(string email, string password)
        {
        ...
        public virtual NhanVien getNhanVienByEmail(string email)
        {
        ...
        public virtual void ResetMatKhau(string mk, string email)
        {
        ...
        public virtual List<NhanVien> SelectBySql(string sql, Dictionary<string, object> args, CommandType cmdType = CommandType.Text)
        {
        ...
        public virtual NhanVien selectById(string id)
        {
        ...
        public virtual void insertNhanVien(NhanVien nv)
        {
            string sql = @"INSERT INTO NhanVien 
                           (MaNV, HoTen, GioiTinh, Email, MatKhau, DiaChi, VaiTro, TinhTrang) 
        ...
        public virtual void deleteNhanVien(string maNv)
        {
